<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column prop="dbUsername" label="数据库用户" />
...
<script>
import userColumnOps from '@/api/masking/user_column/index'
...
export default {
  name: 'userMaskingColumnList',
  components: { pagination, crudOperation, udOperation },
  cruds() {
    return CRUD({ url: '/api/admin/db/masking/user/column/list', crudMethod: { ...userColumnOps }, title: '用户脱敏列' })
  },
